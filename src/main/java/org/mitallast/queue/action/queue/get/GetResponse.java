...
public class GetResponse implements ActionResponse<GetResponse> {
    ...
    public static class Builder implements EntryBuilder<GetResponse> {
        private QueueMessage message;

        private Builder from(GetResponse entry) {
