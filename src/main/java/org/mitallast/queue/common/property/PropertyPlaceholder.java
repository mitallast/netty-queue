 ...
 * <p/>
 * <p> Values for substitution can be supplied using a {@link java.util.Properties} instance or using a
...
public class PropertyPlaceholder {
    ...
    public PropertyPlaceholder(String placeholderPrefix, String placeholderSuffix,
        ...
        if (placeholderPrefix == null) {
            throw new IllegalArgumentException("Argument 'placeholderPrefix' must not be null.");
        }
        if (placeholderSuffix == null) {
            throw new IllegalArgumentException("Argument 'placeholderSuffix' must not be null.");
        }
