...
public class PollRequest implements ActionRequest<PollRequest> {
    private final DiscoveryNode candidate;
    private final long term;
    private final long logIndex;
    private final long logTerm;

    public PollRequest(DiscoveryNode candidate, long term, long logIndex, long logTerm) {
    ...
    public static class Builder implements EntryBuilder<PollRequest> {
        private DiscoveryNode candidate;
        private long term;
        private long logIndex;
        private long logTerm;

        private Builder from(PollRequest entry) {
        ...
        public PollRequest build() {
            return new PollRequest(candidate, term, logIndex, logTerm);
        }
