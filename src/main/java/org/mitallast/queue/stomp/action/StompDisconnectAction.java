...
public class StompDisconnectAction extends BaseStompHandler {

    @Inject
    public StompDisconnectAction(Settings settings, Client client, StompController controller) {
        super(settings, client);
        controller.registerHandler(StompCommand.DISCONNECT, this);
    }
